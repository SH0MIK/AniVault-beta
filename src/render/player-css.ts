...
:root{
  --sp-accent:#9d6ef8;
  --sp-accent-rgb:157,110,248;
  --sp-accent-glow:rgba(124,58,237,0.45);
  --sp-bg:#08080a;
  --sp-surface:#0d0d10;
  --sp-surface2:#15151b;
  --sp-surface3:#1c1c24;
  --sp-text:#f5f5fa;
  --sp-text-sub:rgba(245,245,250,0.6);
  --sp-text-muted:rgba(245,245,250,0.35);
  --sp-border:rgba(124,58,237,0.28);
  --sp-border2:rgba(124,58,237,0.12);
  --sp-r:16px;
  --sp-hud:'Manrope',sans-serif;
...
.sp-ptab.active{color:var(--sp-accent, #9d6ef8);border-bottom-color:var(--sp-accent, #9d6ef8)}
...
.sp-ep-nav-btn:hover{border-color:var(--sp-accent, #9d6ef8);color:#fff;background:rgba(124,58,237,.07)}
...
.sp-ep-chip:hover{border-color:var(--sp-accent, #9d6ef8);color:#fff;background:rgba(124,58,237,.08)}
.sp-ep-chip.current{border-color:var(--sp-accent, #9d6ef8);background:rgba(124,58,237,.15);color:var(--sp-accent, #9d6ef8)}
...
.sp-ep-more:hover{border-color:var(--sp-accent, #9d6ef8);color:#fff;background:rgba(124,58,237,.08)}
...
.sp-qopt:hover{border-color:var(--sp-accent, #9d6ef8);background:rgba(124,58,237,.06)}
.sp-qopt.active{border-color:var(--sp-accent, #9d6ef8);background:rgba(124,58,237,.12)}
...
.sp-sopt:hover{border-color:var(--sp-accent, #9d6ef8);color:var(--sp-text, #e8eaf0)}
.sp-sopt.active{border-color:var(--sp-accent, #9d6ef8);color:var(--sp-accent, #9d6ef8);background:rgba(124,58,237,.1);text-shadow:0 0 8px rgba(124,58,237,.35)}
...
.sp-stat-item span{color:var(--sp-accent, #9d6ef8)}
...
.sp-kbd{background:var(--sp-surface3, #1e2535);border:1px solid var(--sp-border, rgba(124,58,237,0.15));border-radius:4px;padding:3px 8px;font-family:var(--sp-hud, 'Orbitron',monospace);font-size:.58rem;color:var(--sp-accent, #9d6ef8);white-space:nowrap;flex-shrink:0}
