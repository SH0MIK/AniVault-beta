...
// Only the old "Guest_xxxxxx"/"Guest####" placeholder format counts as
// needing a fix — the current "AdjectiveNoun##" names (e.g. "SwiftVoyager12")
// already look fine and shouldn't get flagged just for being auto-created.
export function isAutoGeneratedUsername(username: string): boolean {
  return /^Guest[_\d]/i.test(username);
}
